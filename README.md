...
- 🌱 I’m currently: Moving private repos to public as much as I can find free time for it. They may be unstable at the moment, I fill fix them later
  - **_soon will be public..._**: ansible, antivirus, atlassian, authentik, aws, aws-loadbalancer-controller, awx, azure, bash, buildx-buildkit, cert-manager, circleci, docker, driftctl, easy-rsa, exporters, external-dns, external-secrets, gcp, git, git-flow, github-actions, gitlab, gpg-pgp, helm, ingress-nginx, jenkins, jsonnet, kafka-fast-data-dev, kimai, kind, kops, kustomize, kwok, minikube, n8n, nginx, nifi, nix, ocserv-openconnect, opa-open-policy-agent, openvz, podman, powershell, prowler, rpm, sealed-secrets, security, skaffold, sops-ksops, spinnaker, steampipe, tekton, terraform, vagrant ...
